...
namespace Caser_Cipher
{
    class Program
    {
            ...
            string Decode = Decoding(Encode, key);
            ...
            public static string Encoding(string userinput, int key)
            {
                ...
                //string[] userinputArray = new string[] { userinput };
        ...
        public static string Decoding(string userinput, int key)
        {
            char[] fixedLetter = new char[26] { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'q', 'x', 'y', 'z' };
